...
export default function Signup({ goToPage }) {
  ...
  return (
    <form onSubmit={handleSubmit} className='container'>
      ...
      <input pattern='\d{4}' title='Your uid should of length 4 numbers' required className='default-input' type="text" autoComplete='off' name="uid" placeholder=' Your unique id*' />
